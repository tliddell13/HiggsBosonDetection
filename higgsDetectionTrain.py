...
model4 = mlp.MLP_mach3(input_size, 300, 260, 220, 180, 140, 100)
model4.to(device)
n_epochs = 6000
...
# Save the model
torch.save(model4.state_dict(), 'model4NoDropout.pth')
# Save the training and testing losses as well  
with open('noDO_train_losses.pkl', 'wb') as f:
    pickle.dump(train_losses, f)

with open('noDO_test_losses.pkl', 'wb') as f:
